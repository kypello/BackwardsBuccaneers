...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (controller.isGrounded && !wasGroundedLastFrame && control && !footstepSoundSets[footstepSoundSetIndex].landSound.isPlaying) {
        ...
        if (input && controller.isGrounded && control) {
